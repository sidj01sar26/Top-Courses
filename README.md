# Top-Courses
A simplified courses displayer that lets you like the courses and also saves them whenever you revisit the website.
...
Check out [React-Toastify (npmJS)](https://www.npmjs.com/package/react-toastify) to add good toasters to your project.

To install react-toasters - write `npm i react-toastify` in your terminal.
